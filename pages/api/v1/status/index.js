...
async function status(request, response) {
  ...
  const databaseConnectionsResult = await database.query("SHOW max_connections;");
  const databaseConnectionsValue = databaseConnectionsResult.rows[0].max_connections;
